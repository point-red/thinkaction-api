...
export class UserEntity {
  ...
  CheckData(usePassword = true) {
    ...
    if (
      this.user.supporter &&
      !(
        Array.isArray(this.user.supporter) ||
        typeof this.user.supporter === "string"
      )
    ) {
    ...
    if (
      this.user.supporting &&
      !(
        Array.isArray(this.user.supporting) ||
        typeof this.user.supporting === "string"
      )
    ) {
    ...
    if (
      this.user.request &&
      !(
        Array.isArray(this.user.request) ||
        typeof this.user.request === "string"
      )
    ) {
    ...
    if (
      ...
      !(
        Array.isArray(this.user.notification) ||
        typeof this.user.notification === "string"
      )
    ) {
      errors.notification =
        "Notification must be an array of strings or a string.";
    }

    if (
      this.user.goalsPerformance &&
      typeof this.user.goalsPerformance !== "number"
    ) {
      errors.goalsPerformance = "GoalsPerformance must be a number.";
    }

    if (
      this.user.supporterCount &&
      typeof this.user.supporterCount !== "number"
    ) {
      errors.supporterCount = "SupporterCount must be a number.";
    }

    if (
      this.user.supportingCount &&
      typeof this.user.supportingCount !== "number"
    ) {
    ...
    if (
      ...
      typeof this.user.notificationCount !== "number"
    ) {
