...
const postController = new post_controller_1.default(getAllPost, getOnePost, getAllLikePost, createResolution, createWeeklyGoals, createCompleteGoals, updateResolutions, updateWeeklyGoals, updateCompleteGoals, likePost, unlikePost, getMonthlyReport, deletePost);
...
router.post('/resolutions', auth_middleware_1.verifyUser, (req, res, next) => postController.createResolution(req, res, next));
router.post('/weeklyGoals', auth_middleware_1.verifyUser, (req, res, next) => postController.createWeeklyGoals(req, res, next));
router.post('/completeGoals', auth_middleware_1.verifyUser, (req, res, next) => postController.createCompleteGoals(req, res, next));
...
router.patch('/:id/resolutions', auth_middleware_1.verifyUser, (req, res, next) => postController.updateResolutions(req, res, next));
router.patch('/:id/weeklyGoals', auth_middleware_1.verifyUser, (req, res, next) => postController.updateWeeklyGoals(req, res, next));
router.patch('/:id/completeGoals', auth_middleware_1.verifyUser, (req, res, next) => postController.updateCompleteGoals(req, res, next));
